...
* ⚙️ Detección de funcionalidades principales
* 🏗️ Identificación de entidades y relaciones del sistema

Este análisis servirá como base para el desarrollo de los diagramas UML.

---

### 2️⃣ Desarrollo de diagramas UML
...
* 🏗️ Defender la estructura del proyecto
...
* 🖥️ Presentación de apoyo (PowerPoint, Canva, Google Slides, etc.)
